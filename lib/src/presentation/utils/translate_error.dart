...
String translateError(BuildContext context, dynamic err) {
  assert(err != null, 'No error given');

  final BuzzerLocalizations loc = BuzzerLocalizations.of(context);
...
String _translateAppException(BuildContext context, AppException err) {
  ...
  switch (err.type) {
    ...
    case AppExceptionType.userNotFound:
      ...
      break;
    case AppExceptionType.doorNotFound:
      txt = loc.doorNotFound;
      break;
    case AppExceptionType.doorOpeningFailed:
      txt = loc.doorOpeningFailed;
      break;
